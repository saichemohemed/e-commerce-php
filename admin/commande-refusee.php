                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <h4 class="card-title">commande refusée</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body card-dashboard">
                                        ...
                                        <table class="table  dataex-html5-selectors ">
                                                ...
                                                <tbody>
                                                <?php    
                                                $query = "SELECT *, m.id AS idcommande , p.id AS idpanier FROM commande as m JOIN panier as p ON m.id = p.idcommande JOIN produit as pr ON p.idproduit = pr.id JOIN client as cl ON m.idclient = cl.id WHERE  m.etat='refusee'";
