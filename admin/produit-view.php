                        ...
                        <div class="card-body">
                            ...
                            if (isset($_GET['id'])){
                                ...
                                <div class="form-group">
                                    <div class="controls">
                                        <label>titre</label>
                                        <input type="text" name="titre" readonly class="form-control" placeholder="Titre" value='<?php echo  utf8_encode($row["titre"]); ?>' required data-validation-required-message="This name field is required">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="controls">
                                        <label>prix</label>
                                        <input type="number" name="prix" readonly  class="form-control" placeholder="prix" value='<?php echo  $row["prix"]; ?>' required data-validation-required-message="This name field is required">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>contenu</label>
                                    <fieldset class="form-label-group mb-0">
                                        <textarea name="contenu" readonly data-length=2500  class="form-control char-textarea" id="textarea-counter" rows="3" placeholder="ecrir .."><?php echo utf8_encode($row["contenu"]); ?></textarea>
                                    </fieldset>
                                </div> 
                                <div class="form-group">
                                    <label>Description</label>
                                    <fieldset class="form-label-group mb-0">
                                        <textarea name="Description" readonly data-length=2500  class="form-control char-textarea" id="textarea-counter" rows="3" placeholder="ecrir .."><?php echo utf8_encode($row["Description"]); ?></textarea>
                                    </fieldset>
                                </div>                                 
                                <div class="form-group">
                                <label>Specification</label>
                                    <fieldset class="form-label-group mb-0">
                                        <textarea name="Specification" readonly data-length=2500  class="form-control char-textarea" id="textarea-counter" rows="3" placeholder="ecrir .."><?php echo utf8_encode($row["Specification"]); ?></textarea>
                                    </fieldset>
                                </div> 
                                    <div class="form-group">
                                    <div class="controls  mt-20">
                                    <img src="<?php echo  $row["url-img"].$row["nom-img"]; ?>" style="height: 100px;">                                    </div>
                                </div>      
